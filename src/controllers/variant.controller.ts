...
export const variant_controller = {
  ...
  update: async (req: Request, res: Response) => {
    const { data, status } = await variant_services.update(
      req.params.id,
      req.body
    );
    return res.status(status).json(data);
  ...
  delete: async (req: Request, res: Response) => {
    const { data, status } = await variant_services.delete(req.params.id);
    return res.status(status).json(data);
  },
  ...
  getById: async (req: Request, res: Response) => {
    const { data, status } = await variant_services.getById(req.params.id);
    return res.status(status).json(data);
  },
};
